...
public class Expense : BaseAuditableEntity
{
    ...
    public Expense(DateTime date, string description, Money amount, Guid? categoryId = null, Guid? costCenterId = null, Guid? recurringPatternId = null, string? documentNumber = null)
    {
        Date = date;
